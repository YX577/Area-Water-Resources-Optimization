...
for i = 1 : N
    ...
    if rand(1) < 0.9
        ...
        child_1(:,V + 1: M + V + 1) = evaluate_objective(child_1, M, V);
        child_2(:,V + 1: M + V + 1) = evaluate_objective(child_2, M, V);
    ...
    % polynomial mutation. 
        ...
        % concatenate the offspring chromosome with objective value.    
        child_3(:,V + 1: M + V + 1) = evaluate_objective(child_3, M, V);
